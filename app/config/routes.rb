Rails.application.routes.draw do
  ...
  get "problems/:id/template", to: "problem#template", as: "problem_template"
  ...
  post "sandbox/:token/checkin/confirm", to: "sandbox#complete_checkin", constraints: sandbox_token_constraint
